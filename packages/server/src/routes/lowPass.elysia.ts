...
export function lowPassPlugin(app: Elysia): Elysia {
  return app
    .get('/settings/lowpass', handleGet as never)
    .patch('/settings/lowpass', handlePatch as never, { body: LowPassSchema }) as unknown as Elysia;
}
